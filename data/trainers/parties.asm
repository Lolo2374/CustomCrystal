...
JasmineGroup:
	...
	tr_mon 36, CORSOLA, FEMALE
		tr_extra NATURAL_CURE
		tr_evs 192 HP
		tr_moves ANCIENTPOWER, BUBBLE_BEAM, ICICLE_SPEAR, RECOVER
...
PryceGroup:
	...
	def_trainer 1, "Pryce"
	tr_mon 41, DEWGONG @ CHESTO_BERRY, MALE
		tr_extra HYDRATION
		tr_evs 224 HP
		tr_moves WATERFALL, REST, HAIL, AURORA_BEAM
	tr_mon 40, WEAVILE, MALE
		tr_extra PRESSURE
		tr_evs 224 Atk
		tr_moves SWORDS_DANCE, ICICLE_CRASH, FURY_STRIKES, NIGHT_SLASH
	tr_mon 40, CLOYSTER, MALE
		tr_extra SHELL_ARMOR
		tr_evs 224 HP
		tr_moves DEFENSE_CURL, SUPERSONIC, WATER_PULSE, ICE_SHARD
	tr_mon 42, DONPHAN, MALE
		tr_extra STURDY
		tr_evs 224 HP
		tr_moves DEFENSE_CURL, ROLLOUT, BULLDOZE, ICE_SHARD
	tr_mon 44, MAMOSWINE @ SITRUS_BERRY, MALE
		tr_extra OBLIVIOUS
		tr_evs 224 Atk
...
ClairGroup:
	...
	tr_mon 46, LAPRAS, FEMALE
		tr_extra WATER_ABSORB
		tr_evs 252 HP
		tr_moves DRAGON_PULSE, CONFUSE_RAY, SURF, ICE_BEAM
	tr_mon 48, DRAGONAIR, FEMALE
		tr_extra SHED_SKIN
		tr_evs 128 HP, 128 Spe
		tr_moves THUNDER_WAVE, AQUA_TAIL, FLAMETHROWER, DRAGON_PULSE
	tr_mon 46, AMPHAROS, FEMALE
		tr_extra STATIC
	...
	tr_mon 49, KINGDRA @ SHELL_BELL, FEMALE
		tr_extra SNIPER
	...
	tr_mon 72, GYARADOS @ LEFTOVERS, FEMALE
		tr_extra INTIMIDATE, SPE_UP_SATK_DOWN
		tr_evs 252 Atk, 4 Def, 252 Spe
		tr_moves DRAGON_DANCE, WATERFALL, OUTRAGE, EARTHQUAKE
...
endc
	...
	tr_mon 75, KINGDRA @ SCOPE_LENS, FEMALE
		...
		tr_moves DRAGON_PULSE, SURF, ICE_BEAM, HYPER_BEAM
	end_trainer
...
WillGroup:
	...
	tr_mon 69, SLOWKING @ ROCKY_HELMET, MALE
	...
	tr_mon 70, XATU @ LEFTOVERS, MALE
		...
		tr_moves RECOVER, PSYCHIC_M, DAZZLINGLEAM, CALM_MIND
	end_trainer
...
KogaGroup:
	...
	tr_mon 69, ARBOK @ FOCUS_SASH, MALE | ARBOK_KOGA_FORM
		tr_extra INTIMIDATE, ATK_UP_SATK_DOWN
		tr_evs 252 Atk, 4 Def, 252 Spe
		tr_moves GUNK_SHOT, GLARE, EARTHQUAKE, CRUNCH
...
BrunoGroup:
	...
	def_trainer 1, "Bruno"
	tr_mon 53, HERACROSS @ FOCUS_SASH, MALE
		tr_extra GUTS
		tr_evs 176 Atk, 176 Spe
		tr_moves PURSUIT, CLOSE_COMBAT, MEGAHORN, COUNTER
	tr_mon 55, RHYPERIOR @ HARD_STONE, MALE
		tr_extra SOLID_ROCK
		tr_evs 176 Hp, 176 Atk
		tr_moves STONE_EDGE, IRON_HEAD, EARTHQUAKE, CLOSE_COMBAT
	tr_mon 53, HITMONLEE @ FOCUS_BAND, MALE
		tr_extra RECKLESS
		tr_evs 176 Atk, 176 Spe
		tr_moves SUCKER_PUNCH, STONE_EDGE, HI_JUMP_KICK, FOCUS_ENERGY
	tr_mon 53, HITMONCHAN @ NEVERMELTICE, MALE
		tr_extra IRON_FIST
		tr_evs 176 Atk, 176 Spe
		tr_moves THUNDERPUNCH, ICE_PUNCH, POISON_JAB, MACH_PUNCH
	tr_mon 55, STEELIX @ HARD_STONE, MALE
		tr_extra SHEER_FORCE
		tr_evs 100 HP, 252 Atk
		tr_moves IRON_HEAD, EARTHQUAKE, CRUNCH, ROCK_SLIDE
	tr_mon 57, MACHAMP @ LEFTOVERS, MALE
		tr_extra NO_GUARD
		tr_evs 100 HP, 252 Atk
	...
	def_trainer 2, "Bruno"
	tr_mon 70, HERACROSS @ FOCUS_SASH, MALE
		tr_extra GUTS, ATK_UP_SATK_DOWN
		tr_evs 252 HP, 4 Def, 252 Atk
		tr_moves PURSUIT, CLOSE_COMBAT, MEGAHORN, COUNTER
	tr_mon 71, RHYPERIOR @ HARD_STONE, MALE
		tr_extra SOLID_ROCK, ATK_UP_SATK_DOWN
		tr_evs 176 Hp, 176 Atk
		tr_moves STONE_EDGE, IRON_HEAD, EARTHQUAKE, CLOSE_COMBAT
...
KarenGroup:
	...
	def_trainer 1, "Karen"
	tr_mon 55, UMBREON @ LEFTOVERS, FEMALE
		tr_extra SYNCHRONIZE
		tr_evs 252 HP, 132 Def
		tr_moves MUD_SLAP, CONFUSE_RAY, FEINT_ATTACK, MEAN_LOOK
	tr_mon 55, PERSIAN @ FAIRYFEATHER, FEMALE | ALOLAN_FORM
		tr_extra TECHNICIAN
	...
	tr_mon 57, GENGAR @ SPELL_TAG, FEMALE
		...
		tr_moves SHADOW_BALL, WILL_O_WISP, SLUDGE_BOMB, DESTINY_BOND
	tr_mon 57, HONCHKROW @ BLACKGLASSES, FEMALE
		tr_extra SUPER_LUCK
	...
	def_trainer 2, "Karen"
	tr_mon 71, UMBREON @ TOXIC_ORB, FEMALE
if DEF(FAITHFUL)
		tr_extra SYNCHRONIZE, DEF_UP_ATK_DOWN
else
		tr_extra POISON_HEAL, DEF_UP_ATK_DOWN
endc
...
ChampionGroup:
	...
	tr_mon 59, GYARADOS @ MUSCLE_BAND, MALE
		tr_extra INTIMIDATE, SPE_UP_SATK_DOWN
		tr_evs 164 Atk, 252 Spe
		tr_moves DRAGON_DANCE, OUTRAGE, WATERFALL, EARTHQUAKE
	tr_mon 60, DRAGONITE @ WIDE_LENS, MALE
		tr_extra INNER_FOCUS, SATK_UP_ATK_DOWN
		tr_evs 164 SAt, 252 Spe
		tr_moves FIRE_BLAST, BLIZZARD, THUNDER, DRAGON_PULSE
	tr_mon 60, YANMEGA @ SCOPE_LENS, MALE
		tr_extra TINTED_LENS, SATK_UP_ATK_DOWN
		tr_evs 164 SAt, 252 Spe
		tr_moves BUG_BUZZ, DRAGON_PULSE, GIGA_DRAIN, HYPER_BEAM
	tr_mon 59, AERODACTYL @ KINGS_ROCK, MALE
		tr_extra TOUGH_CLAWS, ATK_UP_SATK_DOWN
		tr_evs 164 Atk, 252 Spe
		tr_moves AERIAL_ACE, ANCIENTPOWER, ROCK_SLIDE, GIGA_IMPACT
	tr_mon 59, CHARIZARD @ WISE_GLASSES, MALE
...
endc
	tr_mon 62, DRAGONITE @ LEFTOVERS, MALE
		tr_extra MULTISCALE, ATK_UP_SATK_DOWN, SHINY
		tr_evs 252 HP, 164 Atk
		tr_moves OUTRAGE, DRAGON_DANCE, FLY, EXTREMESPEED
	end_trainer
	...
	tr_mon 77, YANMEGA @ CHOICE_SPECS, MALE
		tr_extra TINTED_LENS, SATK_UP_ATK_DOWN
		tr_evs 252 SAt, 4 Def, 252 Spe
		tr_moves BUG_BUZZ, DRAGON_PULSE, GIGA_DRAIN, HYPER_BEAM
...
endc
	tr_mon 65, VILEPLUME, FEMALE
		tr_extra CHLOROPHYLL
		tr_evs 252 SAt, 132 Spe
		tr_moves SUNNY_DAY, HEALINGLIGHT, DARK_PULSE, SOLAR_BEAM
...
endc
	...
	tr_mon 74, VILEPLUME @ ASSAULT_VEST, FEMALE
		...
		tr_evs 252 HP, 4 Def, 252 SAt
		tr_moves GIGA_DRAIN, EARTH_POWER, DARK_PULSE, HP_FIRE
if DEF(FAITHFUL)
...
BlueGroup:
	...
	tr_mon 69, UMBREON @ TOXIC_ORB, MALE
if DEF(FAITHFUL)
		tr_extra SYNCHRONIZE
else
		tr_extra POISON_HEAL
endc
	...
	tr_mon 68, ARCANINE @ CHARCOAL, MALE
		tr_extra INTIMIDATE
		tr_evs 252 Atk, 4 SAt, 252 Spe
		tr_moves SACRED_FIRE, WILD_CHARGE, EXTREMESPEED, FLAME_CHARGE
...
endc
	...
	def_trainer 2, "Blue"
	tr_mon 80, PIDGEOT @ FOCUS_SASH, MALE
		tr_extra NO_GUARD, SPE_UP_ATK_DOWN
		tr_evs 4 HP, 252 SAt, 252 Spe
		tr_moves HURRICANE, FOCUS_BLAST, U_TURN, ROOST
	tr_mon 79, UMBREON @ TOXIC_ORB, MALE
if DEF(FAITHFUL)
		tr_extra SYNCHRONIZE, DEF_UP_ATK_DOWN
else
		tr_extra POISON_HEAL
endc
	...
	tr_mon 79, EXEGGUTOR @ CUSTAP_BERRY, MALE
		tr_extra HARVEST, SATK_UP_SPE_DOWN
		tr_evs 252 HP, 4 Atk, 252 SAt
		tr_moves PSYCHIC_M, LOW_KICK, ENERGY_BALL, ENDURE
	tr_mon 79, TYRANITAR @ ASSAULT_VEST, MALE
		tr_extra SAND_STREAM, ATK_UP_SATK_DOWN
		tr_evs 252 HP, 4 SDf, 252 Atk
		tr_moves STONE_EDGE, CRUNCH, EARTHQUAKE, AVALANCHE
	tr_mon 79, ARCANINE @ CHOICE_BAND, MALE
		tr_extra INTIMIDATE, ATK_UP_SATK_DOWN
		tr_evs 252 Atk, 4 Def, 252 Spe
		tr_moves CLOSE_COMBAT, OUTRAGE, SACRED_FIRE, EXTREMESPEED
...
def_trainer RIVAL1_14, "<RIVAL>"
	...
	tr_mon 49, TYPHLOSION @ SITRUS_BERRY, MALE
		tr_extra BLAZE
		tr_evs 144 SAt, 144 Spe
		tr_moves SMOKESCREEN, REVERSAL, DIG, FLARE_BLITZ
	end_trainer
...
endc
	...
	tr_mon 65, TYPHLOSION @ CHARCOAL, MALE
		...
		tr_moves FLARE_BLITZ, EARTHQUAKE, THUNDERPUNCH, ROCK_SLIDE
	end_trainer
