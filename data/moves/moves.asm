...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move DOUBLE_SLAP,     EFFECT_DOUBLE_HIT,         30, NORMAL,    100, 15,   0, PHYSICAL
	move AERIAL_ACE,      EFFECT_ALWAYS_HIT,         60, FLYING,     -1, 20,   0, PHYSICAL
	move DRAGON_CLAW,     EFFECT_NORMAL_HIT,         85, DRAGON,    100, 15,   0, PHYSICAL
	...
	move AIR_SLASH,       EFFECT_FLINCH_HIT,         80, FLYING,     100, 15,  20, SPECIAL
...
endc
	...
	move WING_ATTACK,     EFFECT_PRIORITY_HIT,       40, FLYING,    100, 30,   0, PHYSICAL
...
endc
	...
	move HYDRO_PUMP,      EFFECT_NORMAL_HIT,        110, WATER,      85,  5,   0, SPECIAL
...
endc
	...
	move ROCK_THROW,      EFFECT_NORMAL_HIT,         50, ROCK,       95, 15,   0, PHYSICAL
...
endc
	...
	move ICICLE_CRASH,    EFFECT_FLINCH_HIT,         85, ICE,        100, 10,  10, PHYSICAL
...
if DEF(FAITHFUL)
	...
	move FURY_STRIKES,    EFFECT_MULTI_HIT,          20, FLYING,     100, 15,   0, PHYSICAL
endc
	move BONEMERANG,      EFFECT_DOUBLE_HIT,         50, GROUND,     90, 10,   0, PHYSICAL
	move REST,            EFFECT_HEAL,                0, PSYCHIC,    -1, 5,    0, STATUS
	move ROCK_SLIDE,      EFFECT_FLINCH_HIT,         75, ROCK,       100, 10,  20, PHYSICAL
	...
	move FLAME_CHARGE,    EFFECT_PRIORITY_HIT,       40, FIRE,      100, 30,   0, PHYSICAL
...
endc
	...
	move WIILD_CHARGE,    EFFECT_NORMAL_HIT,         90, ELECTRIC,  100, 15,   0, PHYSICAL
...
endc
	move CROSS_CHOP,      EFFECT_NORMAL_HIT,        100, FIGHTING,   85,  5,   0, PHYSICAL
